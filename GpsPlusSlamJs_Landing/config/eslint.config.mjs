...
export default defineConfig(
  ...
  // Shared project defaults
  {
    ...
    rules: {
      ...
      complexity: ["warn", 10],
      "max-depth": ["warn", 4],
      // The landing page is deliberately dependency-light (three.js +
      // anime.js only). It is a marketing surface, not an app: it must never
      // grow a dependency on the framework or the closed-source core — the
      // demo apps it links to are where those belong.
      "no-restricted-imports": [
        "error",
        {
          paths: [
            {
              ...
              message:
                "The landing page must stay framework-free; move app logic into one of the demo apps instead.",
            },
            {
          ...
          patterns: [
            {
              group: ["gps-plus-slam-js/*", "gps-plus-slam-app-framework/*"],
              message:
                "The landing page must stay framework-free; move app logic into one of the demo apps instead.",
            },
          ],
