...
export interface OccupancyOptions {
   ...
   * space. Default `DEFAULT_OCCUPANCY_MIN_OBSERVATIONS` (2; framework FAST-reconstruction
   * default, shared with the PhysicsDemo — was 3). 1 = unfiltered/legacy. Higher = less noise but
...
export const DEFAULT_RECORDING_OPTIONS: RecordingOptions = {
  ...
  occupancy: {
    cellSizeM: DEFAULT_OCCUPANCY_CELL_SIZE_M, // 18 cm voxels — framework FAST-reconstruction default (2026-07-15 device tuning); coarser/faster than the old 15 cm. Shared with the PhysicsDemo.
    minConfidence: DEFAULT_OCCUPANCY_MIN_OBSERVATIONS, // ≥2 observations to render a voxel — framework noise floor (2026-07-15; was 3). Lower = surfaces mesh sooner; 1 = legacy/unfiltered. Shared with the PhysicsDemo.
